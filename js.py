    ...
    const observer = new MutationObserver(() => {
        ...
        if (ed_btn && ed_group && !ed_btn.dataset.bound) {
            ...
            ed_btn.addEventListener('click', function () {
                ...
                if (ed_group.classList.contains('show')) {
                    ed_group.classList.remove('show');
                } else {
                    ed_group.classList.add('show');
                }
            });
        ...
        if (df_btn && df_group && !df_btn.dataset.bound) {
            ...
            df_btn.addEventListener('click', function () {
                // Toggle visibility using CSS classes
                if (df_group.classList.contains('show')) {
                    df_group.classList.remove('show');
                } else {
                    df_group.classList.add('show');
                }
            });
